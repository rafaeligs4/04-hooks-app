...
export type ScrambleWordActions = |  { type: 'NO_SE_CUALES_ACCIONES_HACER'}
...
export const ScrambleWordReducer = (state: ScrambleWordState, action: ScrambleWordActions): ScrambleWordState=>{
